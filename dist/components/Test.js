...
function Test() {
  var _useStateHistoryTree = (0, _useStateHistoryTree4.default)("blue"),
      _useStateHistoryTree2 = _slicedToArray(_useStateHistoryTree, 3),
      color = _useStateHistoryTree2[0],
      setColor = _useStateHistoryTree2[1],
      ...
      getCurrentSubtree = _useStateHistoryTree3.getCurrentSubtree,
